...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState: pacman.GameState):
        ...
        #starting with corners that are not visited
        self.cornersVisited = [False, False, False, False]
        #used tuples for pacman's position and the cornersVisited list
    ...
    def getSuccessors(self, state: Any):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                ...
                #update the corners visited.
                nextCornersVisited = list(cornersVisited)  # Copy the current state of corners visited
                if nextPosition in self.corners:
                    cornerIndex = self.corners.index(nextPosition)
                    nextCornersVisited[cornerIndex] = True

                #append the updated state to the successors list.
...
def foodHeuristic(state: Tuple[Tuple, List[List]], problem: FoodSearchProblem):
    ...
    farthestFoodDistance = max(util.manhattanDistance(position, food) for food in foodList)
